            ...
            <div class="row flex-center h-100 g-0 px-4 px-sm-0">
                <div class="col col-sm-6 col-lg-7 col-xl-6"><a class="d-flex flex-center text-decoration-none mb-4" href="/">
                    ...
                    <div class="text-center mb-7">
                        ...
                        <p class="text-700">Accede con tu cuenta de administrador de SC</p>
                    </div>
                    ...
                    <form action="{{route("login")}}" method="post">
                        ...
                        <div class="mb-3 text-start">
                            ...
                            <div class="form-icon-container">
                                <input class="form-control form-icon-input" id="email" name="email" type="email" placeholder="name@example.com" /><span class="fas fa-user text-900 fs--1 form-icon"></span>
                            </div>
                        </div>
                        <div class="mb-3 text-start">
                        ...
                        <button type="submitll" class="btn btn-primary w-100 mb-3">Iniciar Sesion</button>
                    </form>
