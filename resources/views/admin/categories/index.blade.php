            ...
            <div class="col col-auto">
                <div class="search-box">
                    <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
                        <input class="form-control search-input search" type="search" placeholder="Buscar categorias"
                               aria-label="Search"/>
            ...
            <div class="modal-body">
                <form id="postCategory" action="{{ route('category_store') }}" method="POST">
                    ...
                    <div class="col-12 text-end">
                        <button class="btn btn-primary" type="submit"><span class="far fa-save"></span> Guardar</button>
